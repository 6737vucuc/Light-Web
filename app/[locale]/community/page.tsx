...
{!selectedGroup && (
  <nav className="md:hidden fixed bottom-6 left-6 right-6 bg-white/90 backdrop-blur-xl border border-gray-100 z-50 shadow-2xl rounded-3xl overflow-hidden">
    <div className="flex items-center h-20 px-4">
      <button onClick={() => router.push('/community')} className="flex flex-col items-center justify-center h-full relative">
      ...
      {/* زر Home قريب جدًا */}
      <button onClick={() => router.push('/')} className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl text-white shadow-xl shadow-purple-200 -mt-8 border-4 border-gray-50 ml-2">
        <Home size={28} />
      </button>
    </div>
  </nav>
