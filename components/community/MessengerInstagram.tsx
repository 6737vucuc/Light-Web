...
import { 
  ...
  Info, Heart, Trash2, Reply, Check, CheckCheck,
  MessageCircle, X
} from 'lucide-react';
    ...
    try {
      ...
      if (selectedImage) {
        ...
        if (uploadResponse.ok) {
          ...
          alert(uploadError.error || 'Failed to upload file');
      ...
      const defaultContent = messageType === 'video' 
        ? '🎥 Video' 
        : messageType === 'image' 
        ? '📷 Image' 
        : '';
          ...
          <>
            ...
            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {selectedConversation.isOnline && !isTyping && (
            ...
            <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200">
              <div className="flex items-center gap-2">
                <label className="cursor-pointer p-2 hover:bg-gray-100 rounded-full transition-colors" title="Send photo or video">
