...
export function generateCSPHeader(): string {
  return [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.supabase.com wss://*.supabase.com https://*.pooler.supabase.com https://0.peerjs.com wss://0.peerjs.com https://*.neon.tech https://res.cloudinary.com wss://*.pusher.com https://*.pusher.com",
